...
describe('Activity timeline (integration)', () => {
  ...
  afterEach(async () => {
    await prisma.$executeRawUnsafe(
      'TRUNCATE TABLE "CustomerAnalyticsSnapshot", "Notification", "Widget", "Dashboard", "Activity", "ContactTag", "Tag", "Note", "Contact", "User", "UserRole", "Role", "Team", "Report", "Tenant" RESTART IDENTITY CASCADE',
    )
  })
