...
describe('Forecast Integration', () => {
  ...
  beforeEach(async () => {
    ...
    await prisma.$executeRawUnsafe(
      'TRUNCATE TABLE "CustomerAnalyticsSnapshot", "Notification", "Widget", "Dashboard", "ForecastSnapshot", "Deal", "User", "Report", "Tenant", "DealStage", "Team", "Role", "Permission", "RolePermission", "UserRole" CASCADE',
    )
