...
describe('Deal document & comment collaboration (integration)', () => {
  ...
  afterEach(async () => {
    await prisma.$executeRawUnsafe(
      'TRUNCATE TABLE "Notification", "Deal", "DealStage", "Note", "Contact", "User", "UserRole", "Role", "Permission", "RolePermission", "Team", "Tenant", "DealDocument", "DealComment", "DealCommentMention", "AuditLog" RESTART IDENTITY CASCADE',
    )
