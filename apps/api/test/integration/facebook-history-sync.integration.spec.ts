...
describe('Facebook history sync (integration)', () => {
  ...
  afterEach(async () => {
    await prisma.$executeRawUnsafe(
      'TRUNCATE TABLE "CustomerAnalyticsSnapshot", "Notification", "Widget", "Dashboard", "Message", "Conversation", "ContactChannelIdentity", "Note", "Contact", "ChannelConnection", "UserRole", "Role", "User", "Report", "Tenant" RESTART IDENTITY CASCADE',
    )
