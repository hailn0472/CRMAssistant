...
describe('Facebook history sync (integration)', () => {
  ...
  afterEach(async () => {
    await prisma.$executeRawUnsafe(
      'TRUNCATE TABLE "Notification", "Widget", "Dashboard", "Message", "Conversation", "ContactChannelIdentity", "Note", "Contact", "ChannelConnection", "UserRole", "Role", "User", "Tenant" RESTART IDENTITY CASCADE',
    )
