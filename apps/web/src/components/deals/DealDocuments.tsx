    ...
    <div className="space-y-4">
      ...
      {error ? (
        ...
        <EmptyState
          ...
          description="Attach contracts, proposals and other deal files here so the whole team can find them."
        />
      ) : (
            ...
            <tbody>
              {documents.map((document) => (
                <tr key={document.id} className="border-b border-slate-100">
                  ...
                  <td className="px-4 py-3 text-slate-600">{formatFileSize(document.fileSize)}</td>
